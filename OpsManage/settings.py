...
TEMPLATES = [
    {
        ...
        'DIRS': ["/data/OpsManage/OpsManage/static/",'/data/OpsManage/OpsManage/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DOCKER_IMAGE={
    "tomcat": "registry.cn-shanghai.aliyuncs.com/jhhjdk/tomcat8:v7",
    "jdk": "registry.cn-shanghai.aliyuncs.com/jhhjdk/java:1.8v7"
}
...
DOCKER_REGISTRY={
    "test": "docker.jhh.com",
    "prod": "registry-vpc.cn-shanghai.aliyuncs.com/jinhh"
}
