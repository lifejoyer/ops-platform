                ...
                if project_env != 'prod':
                    ...
                    try:
                        ...
                        while building:
                            ...
                            if build_status:
                                time.sleep(2)
                                logger.info(msg="jenkins job building")
                            else:
                                break
                        DsRedis.OpsDeploy.lpush(project.project_uuid,data="Jenkins job building done")
                    except Exception as ex:
                        DsRedis.OpsProject.delete(redisKey=project.project_uuid + "-locked")
                        return JsonResponse({'msg': "jenkins获取构建状态失败", "code":500,'data':[]})
