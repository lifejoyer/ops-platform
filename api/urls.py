...
urlpatterns = [
            ...
            url(r'jenkins/$', assets_api.jenkins_list),
            url(r'jenkins/(?P<id>[0-9]+)/$', assets_api.jenkins_detail),
            url(r'k8s/$', assets_api.k8s_list),
            url(r'k8s/(?P<id>[0-9]+)/$', assets_api.k8s_detail),
            url(r'runenv/$', assets_api.runenv_list),
            url(r'runenv/(?P<id>[0-9]+)/$', assets_api.runenv_detail),
            ...
            url(r'deploy_v2/(?P<id>[0-9]+)/$', deploy_api.deploy_detail_v2),
            ...
            url(r'deploy/logs/(?P<id>[0-9]+)/$', deploy_api.deployLogs_detail),
